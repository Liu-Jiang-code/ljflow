...
export const zhCN: Translations = {
  ...
  welcome: {
    greeting: "你好，欢迎回来！",
    description:
      // "欢迎使用 🦌 灵境·数智研究员，一个完全开源的超级智能体。通过内置和自定义的 Skills，\n灵境·数智研究员 可以帮你搜索网络、分析数据，还能为你生成幻灯片、\n图片、视频、播客及网页等，几乎可以做任何事情。",
      // "欢迎使用 灵境·数智研究员。通过内置和自定义的 Skills，\n灵境·数智研究员 可以帮你搜索网络、分析数据，还能为你生成幻灯片、\n图片、视频、播客及网页等，几乎可以做任何事情。",
      "欢迎使用 灵境·数智研究员--您的军事理论助理。\n通过集成全网深度调研、军事学术审阅、多维数据分析、战略简讯简报生成等技能，\n为您提供从军事情报获取、军事理论分析到战略报告生成的全流程军事理论研究支持。",
    createYourOwnSkill: "创建你自己的 Agent SKill",
    createYourOwnSkillDescription:
      "创建你的 Agent Skill 来释放 灵境·数智研究员 的潜力。通过自定义技能，灵境·数智研究员\n可以帮你深度调研、军事学术审阅、多维数据分析、战略简讯简报生成等技能，\n为您提供从军事情报获取、军事理论分析到战略报告生成的全流程军事理论研究支持。",
  },
  ...
  inputBox: {
    ...
    // 小惊喜提示词
    surpriseMePrompt: "",   // 在frontedn/src/components/workspace/input-box.tsx中 可以注释掉不显示按钮
    ...
    suggestions: [
      ...
      {
        suggestion: "战略分析",
        prompt: "针对 [主题/地区/冲突] 进行战略文件解读，包括发布背景、主要内容和影响分析",
        icon: PenLineIcon,  // 或自定义军事图标
        // skill: "strategic-analysis",
      },
      {
        suggestion: "概念研究",
        prompt: "针对作战概念 [作战概念名称] 进行全面分析，包括提出背景、概念内涵、推进举措",
        icon: GraduationCapIcon,
        // skill: "concept-research",
      },
      {
        suggestion: "项目跟踪",
        prompt: "针对 [项目名称] 分析项目发展现状、最新进展和态势影响",
        icon: ShapesIcon,
  ...
  agents: {
    ...
    saving: "正在保存智能体...",
    saveRequested:
      "已提交保存请求，灵境·数智研究员 正在根据当前对话生成并保存初版智能体。",
    saveHint:
    ...
    agentCreatedPendingRefresh:
      "智能体已创建，但 灵境·数智研究员 暂时还无法读取到它。请稍后刷新当前页面。",
    more: "更多操作",
    agentCreated: "智能体已创建！",
    startChatting: "开始对话",
  ...
  // Workspace
  workspace: {
    officialWebsite: "访问 灵境·数智研究员 官方网站",
    githubTooltip: "访问 灵境·数智研究员 的 Github 仓库",
    settingsAndMore: "设置和更多",
    visitGithub: "在 Github 上查看 灵境·数智研究员",
    reportIssue: "报告问题",
    contactUs: "联系我们",
    about: "关于 灵境·数智研究员",
  },
  ...
  toolCalls: {
    ...
    skillInstallTooltip: "安装技能并使其可在 灵境·数智研究员 中使用",
  },
  ...
  shortcuts: {
    ...
    keyboardShortcutsDescription: "使用键盘快捷键更快地操作 灵境·数智研究员。",
  ...
  settings: {
    title: "设置",
    description: "根据你的偏好调整 灵境·数智研究员 的界面和行为。",
    sections: {
      appearance: "外观",
      memory: "记忆",
      tools: "工具",
    ...
    memory: {
      title: "记忆",
      description:
        "灵境·数智研究员 会在后台不断从你的对话中自动学习。这些记忆能帮助 灵境·数智研究员 更好地理解你，并提供更个性化的体验。",
      empty: "暂无可展示的记忆数据。",
      rawJson: "原始 JSON",
      exportButton: "导出记忆",
      exportSuccess: "记忆已导出",
    ...
    skills: {
      ...
      emptyTitle: "还没有技能",
      emptyDescription:
        "将你的 Agent Skill 文件夹放在 灵境·数智研究员 根目录下的 `/skills/custom` 文件夹中。",
      emptyButton: "创建你的第一个技能",
    },
    notification: {
      title: "通知",
      description:
        "灵境·数智研究员 只会在窗口不活跃时发送完成通知，特别适合长时间任务：你可以先去做别的事，完成后会收到提醒。",
